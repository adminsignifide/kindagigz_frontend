...
import { ROUTES, SOCIALS } from '@/lib/constants/routes';
  ...
  const footerSections = [
    {
      title: 'For Clients',
      links: [
        { label: 'Find Talent', href: ROUTES.SERVICES },
        { label: 'How It Works', href: ROUTES.HOW_IT_WORKS },
        { label: 'Browse Categories', href: `${ROUTES.SERVICES}?tab=categories` },
        { label: 'Pricing', href: '#' },
      ],
    },
    {
  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          ...
          {footerSections.map((section) => (
            <div key={section.title}>
              <h3 className="text-white text-xs md:text-sm font-semibold mb-2 md:mb-4">{section.title}</h3>
        ...
        {/* Bottom Bar */}
        <div className="pt-4 md:pt-6 lg:pt-8 border-t border-gray-800">
